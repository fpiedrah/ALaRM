...
def test():
    ...
    ultra_tokenizer.pad_token_id = ultra_tokenizer.eos_token_id
    ultra_rm = LlamaRewardModel.from_pretrained("TheBloke/UltraRM-13B-GPTQ", device_map={"": current_device}, trust_remote_code=False, revision="gptq-4bit-32g-actorder_True")
    ...
    if accelerator.is_main_process:
        ...
        gathered_list = remove_duplicate_dicts(test_gather_list)
